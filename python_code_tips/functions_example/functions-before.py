...
# Login to DNAC
url = "https://{}:{}/dna/system/api/v1/auth/token".format(dnac["host"], dnac["port"])
...
print("Connected Network Device: {}".format(source_host["connectedNetworkDeviceIpAddress"]))  # noqa: E501

# Print Wired/Wireless Details
if source_host["hostType"] == "wired":
    print("Connected Interface Name: {}".format(source_host["connectedInterfaceName"]))  # noqa: E501
...
# Make API request and return the response body
response = requests.request("GET", destination_url, headers=headers, verify=False)
...
print("Connected Network Device: {}".format(destination_host["connectedNetworkDeviceIpAddress"]))  # noqa: E501

# Print Wired/Wireless Details
if destination_host["hostType"] == "wired":
    print("Connected Interface Name: {}".format(destination_host["connectedInterfaceName"]))  # noqa: E501
